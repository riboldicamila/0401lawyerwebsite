...
export default function MainSection() {
  return (
    <>
      <section
        id="inicio"
        className="relative bg-[#f8f6f2] font-serif overflow-hidden pt-24 pb-16 lg:pt-28 lg:pb-24"
      >
        {/* Background elements */}
          ...
          <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-16 max-w-7xl mx-auto">
            ...
            <div className="w-full lg:w-1/2 z-10 order-2 lg:order-1">
              <div className="relative">
                <h1 className="text-3xl sm:text-4xl md:text-5xl font-medium mb-4 text-[#4a4a4a]">
                  Asesoramiento legal{" "}
              ...
              <p className="text-gray-600 mb-6 max-w-lg text-base leading-relaxed">
              ...
              {/* Decorative line */}
              <div className="w-24 h-1 bg-[#5c4532] opacity-90 mb-8"></div>
            ...
            <div className="w-full lg:w-1/2 order-1 lg:order-2">
              <div className="relative h-96 md:h-[450px] lg:h-[500px] max-h-[75vh]">
                {/* Main image */}
